  ...
  return (
    <SettingsLayout title="Suporte" subtitle="Estamos aqui para ajudar">
        ...
        {[
          {
            ...
            label: "Chat ao vivo",
            sublabel: "Resp. em ~2 min",
            bg: "linear-gradient(135deg, #003884, #0065FF)",
            action: () => alert("Iniciando chat..."),
          },
          {
            icon: <Phone size={20} color="#fff" />,
            label: "Ligar",
            sublabel: "(11) 3000-4000",
            bg: "linear-gradient(135deg, #36B37E, #57D9A3)",
            action: () => alert("Ligando..."),
          },
          {
            icon: <Mail size={20} color="#fff" />,
            label: "E-mail",
            sublabel: "Em até 24h",
            bg: "linear-gradient(135deg, #FF7452, #FFAB00)",
            action: () => alert("Abrindo e-mail..."),
          },
        ].map((item) => (
          <button
            key={item.label}
      ...
      >
        ...
        >
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
            <path
              d="M11 2C6.03 2 2 6.03 2 11c0 1.64.43 3.18 1.18 4.52L2 20l4.62-1.21A8.93 8.93 0 0011 20c4.97 0 9-4.03 9-9s-4.03-9-9-9zm4.42 12.42c-.19.53-.95 1-1.56 1.13-.41.09-.95.16-2.77-.59-2.33-.95-3.83-3.28-3.95-3.44-.12-.16-.95-1.26-.95-2.41 0-1.15.6-1.71.81-1.95.21-.24.46-.3.61-.3.15 0 .3 0 .43.01.14.01.33-.05.51.39.19.45.65 1.58.71 1.7.06.12.1.26.02.42-.08.16-.12.26-.24.4-.12.14-.25.32-.36.43-.12.12-.24.25-.1.49.14.24.62.99 1.33 1.6.91.8 1.68 1.04 1.92 1.16.24.12.38.1.52-.06.14-.16.59-.69.75-.93.16-.24.32-.2.54-.12.22.08 1.4.66 1.64.78.24.12.4.18.46.28.06.1.06.57-.13 1.1z"
              fill="white"
            />
          </svg>
        </div>
      ...
      <SettingsSection title="Recursos">
        {[
          {
            icon: <BookOpen size={16} color={BLUE} />,
            iconBg: "#EBF3FF",
            label: "Central de ajuda",
            sublabel: "Artigos e tutoriais passo a passo",
          },
          {
            icon: <Youtube size={16} color="#FF5630" />,
            iconBg: "#FFF0EC",
            label: "Vídeo-tutoriais",
            sublabel: "Canal FONO-IA no YouTube",
          },
          {
            icon: <Zap size={16} color="#FFAB00" />,
            iconBg: "#FFFBEB",
            label: "Novidades do sistema",
            sublabel: "Ver o que há de novo na versão 2.4",
          },
        ].map((item, idx) => (
          <button
            key={item.label}
            ...
            style={{
              background: "none",
              border: "none",
              borderBottom: idx < 2 ? "1px solid #EBF3FF" : "none",
              cursor: "pointer",
            }}
          >
            <div
      ...
      >
        {faqs.map((faq, idx) => (
          <div
            ...
            style={{
              borderBottom:
                idx < faqs.length - 1 ? "1px solid #EBF3FF" : "none",
            }}
          >
            <button
      ...
      >
        ...
        <button
          onClick={handleSend}
          className="w-auto py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95"
          style={{
            background:
